...
const SignUp = () =>{
    ...
    const submitHandler = (event)=>{
        ...
        let url="";
        if(isLogin){
            url="https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAXiOYJr-9lsF_yoZxTgE3AByKyl3bGlqw";

        }
        else{
            url="https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAXiOYJr-9lsF_yoZxTgE3AByKyl3bGlqw"
        }
        fetch(url,{
            method:'POST',
            body:JSON.stringify({
